...
> `modulesystem.md`, `gdd.md`, `roadmap.md`, `multiplayer.md`, `metagame.md`, корневой `CLAUDE.md`.
>
> **Ветка:** `claude/awesome-bohr-ygnunp` · **PR #1** (draft).
> **Гейт:** `pnpm run check` (lint + typecheck + test). **Тесты: 202 зелёных.**
...
docs/            architecture, modulesystem, roadmap, multiplayer, engineering-risks, gdd, metagame, state(этот)
